    ...
    <div class="container">
        ...
        <div class="table-responsive" id="OutdoorTable" runat="server" visible="false">
            ...
            <asp:GridView ID="DgvOutdoorPrescriptions" runat="server" AutoGenerateColumns="false" 
                ...
                <Columns>
                    <asp:BoundField DataField="PrescriptionId" HeaderText="Prescription" ItemStyle-CssClass="d-none" HeaderStyle-CssClass="d-none" />
                    <%-- Fill this when updated database --%>
                </Columns>
            </asp:GridView>
        </div>
    </div>
        ...
        <h5 class="font-weight-bold">Indoor Prescription Details:</h5>
        <div class="row">
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                <label class="font-weight-bold">Drug Form:</label>
                <asp:TextBox runat="server" CssClass="float-right" ID="PresDrugForm" ValidationGroup="InValidation" ReadOnly="true"></asp:TextBox><br />
                <asp:RequiredFieldValidator ID="rfvDrugForm" runat="server" ErrorMessage="Drug Form is required"
                    ControlToValidate="PresDrugForm" CssClass="text-danger float-right" ValidationGroup="InValidation"></asp:RequiredFieldValidator>
            </div>
                <div class="col-md-4">
        ...
        <div class="row">
            ...
            <div class="flex-column w-100">
                <label class="font-weight-bold">Indoor Prescription Details:</label>
                <br />
                <textarea runat="server" class="w-100" id="PresAddInfo" style="resize: none" rows="5">
                </textarea>
            </div>
    </div>
        ...
        <div id="Outdoor" class="container" runat="server" visible="false" >
            <h5 class="font-weight-bold">Outdoor Prescription Details:</h5>
        <div class="row">
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                <label class="font-weight-bold">Drug Form:</label>
                <asp:TextBox runat="server" CssClass="float-right" ID="txtOutDrugForm" ValidationGroup="OutDrugValidation" ReadOnly="true"></asp:TextBox><br />
                <asp:RequiredFieldValidator ID="rfvOutDrugForm" runat="server" ErrorMessage="Drug Form is required"
                    ControlToValidate="txtOutDrugForm" CssClass="text-danger float-right" ValidationGroup="OutDrugValidation"></asp:RequiredFieldValidator>
            </div>
                <div class="col-md-4">
                <label class="font-weight-bold">Drug Dose:</label>
        ...
        <div class="row">
            ...
            <div class="row col-sm-12">
            <div class="flex-column w-100">
                <label class="font-weight-bold">Outdoor Prescription Details:</label>
                <br />
                <textarea runat="server" class="w-100" id="txtOutPresDetails" style="resize: none" rows="5"></textarea>
            </div>
        </div>
