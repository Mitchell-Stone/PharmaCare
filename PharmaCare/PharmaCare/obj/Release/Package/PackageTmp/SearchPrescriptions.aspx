...
<asp:Content ID="Content2" ContentPlaceHolderID="mainPlaceholder" runat="server">
    ...
    <div class="row">
        ...
        <div class="container">    <%--Start of the top chart --%>        
            <asp:GridView ID="gvPrescriptions" runat="server" AutoGenerateColumns="False" AllowSorting="True" DataKeyNames="PrescriptionId"
                CssClass="table table-bordered table-striped table-condensed" CellPadding="4" ForeColor="#333333" GridLines="None" OnRowCommand="dgvPrescriptions_RowCommand">
            <AlternatingRowStyle BackColor="White" ForeColor="#284775" />              
                <Columns>
                    ...
                    <ItemTemplate>  
                        <asp:Button runat="server" Text="View Drugs" CommandName="ViewDrugs" 
                            CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"
                            CssClass="btn btn-outline-primary m-2 btn-md btn-block" ID="btnViewDrugs"
                            AutoPostBack="false"/>                                     
                    </ItemTemplate>
                </asp:TemplateField>
                </Columns>                             
          ...
          <%--End of the top chart above --%>   
          <%--Start of the bottom chart below --%>   
            <asp:GridView ID="gvDetailsPrescription" runat="server"   DataKeyNames="PrescriptionId" 
                CssClass="table table-bordered table-striped table-condensed" CellPadding="4" AutoGenerateRows="False" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False">
                <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
